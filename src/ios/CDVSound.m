...
- (void)isPlayingAudio:(CDVInvokedUrlCommand*)command
{
    ...
    /*
    if (isPlaying) {
        [self onStatus:MEDIA_STATE mediaId:0 param:@(MEDIA_RUNNING)];
    } else {
        [self onStatus:MEDIA_STATE mediaId:0 param:@(MEDIA_STOPPED)];
    }
    */
